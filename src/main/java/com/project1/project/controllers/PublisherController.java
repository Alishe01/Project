...
import com.project1.project.models.Publisher;
import com.project1.project.reposotories.PublisherRepository;
...
public class PublisherController {
    ...
    public String addsPublisher(@ModelAttribute Publisher publisher){
        ...
        publisher1.setId(a);
        publisher1.setFname(publisher.getFname());
        publisher1.setLname(publisher.getLname());
        publisher1.setScore(publisher.getScore());
        publisher1.setClasses(publisher.getClasses());
